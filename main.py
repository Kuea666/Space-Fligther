...
class SpaceGame(GameApp):
    def init_game(self):
        ...
        self.level= StatusWithText(self,100,500, 'Score: %d', 1)
...
class GameKeyboardHandler(KeyboardHandler):
    def init(self, game_app, ship, successor=None):
        super().init(successor)
...
class StatusWithText:
    def init(self, app, x, y, text_template, default_value=0):
        self.x = x
        self.y = y
